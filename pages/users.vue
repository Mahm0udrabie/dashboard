 ...
 <section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="text-2xl font-medium title-font mb-4 text-blue-600 tracking-widest">All Members <fa icon="users" /></h1>
    </div>
    <div v-for="(user, index) in users" :key="index" class="flex flex-wrap -m-4">
